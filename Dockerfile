...
##   $ docker build -t php-for-liwenxin2006-react-native-elm .
##
## RUNNING
##   $ docker run -p 9000:9000 php-for-liwenxin2006-react-native-elm
##
## CONNECTING
...
ENV STACKSMITH_STACK_ID="dusgph7" \
    STACKSMITH_STACK_NAME="PHP for liwenxin2006/React-Native-elm" \
